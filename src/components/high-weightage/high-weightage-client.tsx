...
export function HighWeightageClient() {
  return (
    <div className="flex flex-col gap-5 p-5 overflow-auto">
      ...
      {/* ── Nifty Sector weights card now lives in the same grid as every
          other index card, instead of its own constrained-width row above
          it, so other cards flow in beside it wherever there's space. ── */}
